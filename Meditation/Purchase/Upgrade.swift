...
class Upgrade: UIViewController {
	...
	func createTermsTextView() {
		...
		let attributedStringColor: NSDictionary = [NSAttributedStringKey.foregroundColor: UIColor.white]
		let attributedString = NSMutableAttributedString(string: Constants.Strings.UPGRADE_SCREENS_INFO, attributes: (attributedStringColor as! [NSAttributedStringKey : Any]))
	...
	@objc func closeButtonPressed() {
		Utils.presentView(self, viewName: Utils.string(key: Constants.Defaults.PREVIOUS_VIEW))
	}
